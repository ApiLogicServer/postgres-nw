...
projectname="postgres-nw"  # lower case, only
resourcegroup="postgres-nw_rg"
...
# git clone https://github.com/apilogicserver/postgres-nw.git
# cd postgres-nw
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name postgres-nw --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
