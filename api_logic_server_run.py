...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.17, August 21, 2023 15:44:37):
...
app_logger.info(f'Created August 21, 2023 15:44:37 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.02.17\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.02.17\n'
    if is_docker():
