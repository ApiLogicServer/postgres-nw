...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.12, August 20, 2023 07:18:27):
...
app_logger.info(f'Created August 20, 2023 07:18:27 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.02.12\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.02.12\n'
    if is_docker():
