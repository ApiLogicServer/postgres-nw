...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.02.05, August 13, 2023 16:58:59):
...
app_logger.info(f'Created August 13, 2023 16:58:59 at {str(current_path)}\n')
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version 09.02.05\n'
    if is_docker():
    ...
    msg = f'API Logic Project Loaded (WSGI), version 09.02.05\n'
    if is_docker():
